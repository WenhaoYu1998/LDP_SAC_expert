...
def parse_args():
    ...
    # ambs
    parser.add_argument('--sep_rew_dyn', default=False, action='store_true')
    parser.add_argument('--sep_rew_ratio', default=0.5, type=float)
    parser.add_argument('--adaptive_ratio', default=False, action='store_true')
    parser.add_argument('--adaptive_ratio_init', default=0.5, type=float)
    parser.add_argument('--deep_metric', default=False, action='store_true')
...
def make_agent(obs_shape, action_shape, args, device):
    if args.agent == 'baseline':
        ...
        agent = AMBSRatioAgent(
            ...
            num_filters=args.num_filters,
            bisim_coef=args.bisim_coef,
            sep_rew_dyn=args.sep_rew_dyn,
            sep_rew_ratio=args.sep_rew_ratio,
            adaptive_ratio=args.adaptive_ratio,
            deep_metric=args.deep_metric,
        )
